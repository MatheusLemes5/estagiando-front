  ...
  .btn:not(:disabled):not(.disabled) {
    ...
    .btn:not(:disabled):not(.disabled):active, .btn:not(:disabled):not(.disabled).active {
      ...
      .btn:not(:disabled):not(.disabled):active:focus, .btn:not(:disabled):not(.disabled).active:focus {
        box-shadow: 0 0 0 0.2rem rgba(111, 66, 193, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125); }
...
.custom-select {
  ...
  .custom-select:focus {
    border-color: #b8a2e0;
    outline: 0;
    box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(111, 66, 193, 0.25); }
...
.custom-range {
  ...
  .custom-range:focus {
    ...
    .custom-range:focus::-webkit-slider-thumb {
      box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(111, 66, 193, 0.25); }
  ...
  .custom-range::-webkit-slider-thumb {
    ...
    .custom-range::-webkit-slider-thumb:active {
      background: #d5c8ed linear-gradient(180deg, #dbd0f0, #d5c8ed) repeat-x; }
